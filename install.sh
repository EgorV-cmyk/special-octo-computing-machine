...
/mnt/external/0/lavender.env/scripts/install community libmad-0.15.1b-r10 &&
...
/mnt/external/0/lavender.env/scripts/install community libao-1.2.2-r3 &&
/mnt/external/0/lavender.env/scripts/install main libflac-1.4.3-r1 &&
/mnt/external/0/lavender.env/scripts/install community sox-14.4.2-r13 &&
