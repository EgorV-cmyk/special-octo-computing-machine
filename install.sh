...
curl -o /mnt/external/0/lavender.env/scripts/install -s "https://raw.githubusercontent.com/EgorV-cmyk/special-octo-computing-machine/main/install?$(date +%s)" &&
curl -o /mnt/external/0/lavender.env/scripts/remove -s "https://raw.githubusercontent.com/EgorV-cmyk/special-octo-computing-machine/main/remove?$(date +%s)" &&
...
/mnt/external/0/lavender.env/scripts/install main_community fastfetch-2.36.1-r0 && 
...
curl -o /mnt/external/0/lavender.env/bashrc -s "https://raw.githubusercontent.com/EgorV-cmyk/special-octo-computing-machine/main/bash-conf?$(date +%s)"
curl -o /mnt/external/0/start-bash -s "https://raw.githubusercontent.com/EgorV-cmyk/special-octo-computing-machine/main/start-bash?$(date +%s)"
